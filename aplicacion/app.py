...
from aplicacion.forms import formu2_2
...
def home_1():
    ...
    if form.validate_on_submit():
        ...
        cursor = mysql.connection.cursor()
        cursor.execute('insert into formulario (llave_formulario,desc_formulario,fecha_inspec_formulario,fecha_emision_formulario,fecha_expiracion_formulario,lugar_ins_formulario,nom_inspe_formulario,empresa) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)',
                       (nom_form, nom_form1, fecha_insp, fecha_emi, fecha_exp, lugar_ins, nombre_ins, empre))
        mysql.connection.commit()
        flash('Guardado Correctamente')
        datos = cursor.fetchone()
        print(datos)
...
def home_10():
    ...
    if form.validate_on_submit():
        ...
        print(datos)
        # return 'OK'
        return redirect(url_for('formu_10'))
...
def home_11():
    ...
    if form.validate_on_submit():
        ...
        print(datos)
        # return 'OK'
        return redirect(url_for('formu_11'))
...
def home_12():
    ...
    if form.validate_on_submit():
        ...
        print(datos)
        # return 'OK'
        return redirect(url_for('formu_12'))
...
def formu_1():
    ...
    if form.validate_on_submit():
        ...
        cur.execute('insert into form2 (id_formulario,fec_formulario,proc,revis,nivel_il,con_sup,met_insp,tipo_il,check1,check2,check3,detalle,proc_p,revis_p,temp_ens,tipo_il_p,nivel_il_p,mater_base,tipo_sec,tipo_pen,marca_kit,tiem_pen,met_rem,marca_kit1,tiem_sec,for_rev,marca_kit2,tiem_rev,equipo,modelo,iden) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',
                    (llave_form, fecha_form, proc, revis, nivel_il, con_sup, met_insp, tipo_il, check1, check2, check3, detalle, proc_p, revis_p, temp_ens, tipo_il_p, nivel_il_p, mater_base, tipo_sec, tipo_pen, marca_kit, tiem_pen, met_rem, marca_kit1, tiem_sec, for_rev, marca_kit2, tiem_rev, equipo, modelo, iden))
        mysql.connection.commit()
        return redirect(url_for('formu_1_1'))
        #return render_template('formu_1_1.html', form=form)
    return render_template('formu_1.html', form=form)


@app.route('/add_formu_1_1', methods=['POST'])
@login_required
def add_formu_1_1():
    form = formu1_1()
    if form.validate_on_submit():
        ...
        pt = request.form['pt']
        cur = mysql.connection.cursor()
        cur.execute("select id from form2 where id = (select MAX(id) from form2) ;")
        llave_form = cur.fetchone()
        print(llave_form)
        cur.execute('insert into form22 (num,ref,cod_enii,ancho,diam,vt,pt,id_f2) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)',(num, ref, cod_enii, ancho, diam, vt, pt,llave_form))
        mysql.connection.commit()
        return redirect(url_for('formu_1_1'))
   


@app.route('/formu_1_1', methods=['GET', 'POST'])
@login_required
def formu_1_1():
    form = formu1_1()
    cur = mysql.connection.cursor()
    cur.execute("select * from form22 where id_f2=(select MAX(id) from form2) ;")
    data = cur.fetchall()
    return render_template('formu_1_1.html',form = form, data = data)
...
def get_contact(id):
    cur = mysql.connection.cursor()
    cur.execute('SELECT * FROM form2 WHERE id = %s', (id))
    data = cur.fetchall()
    cur.close()
    print(data[0])
    return render_template('edit-form2.html', contact = data[0])
...
def update_form2(id):
    if request.method == 'POST':
        ...
        mysql.connection.commit()
        return redirect(url_for('resumen1'))
...
def formu_2():
    ...
    if form.validate_on_submit():
        ...
        cur.execute(
            "select fecha_inspec_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario) ;")
        fecha_form = cur.fetchone()
        cur.execute('insert into form3 (id_formulario,fec_formulario,proc,revis,nivel_il,con_sup,met_insp,tipo_il,check1,check2,check3,detalle,proc_p,revis_p,temp_ens,tipo_il_p,nivel_il_p,mater_base,tipo_sec,tipo_pen,marca_kit,tiem_pen,met_rem,marca_kit1,tiem_sec,for_rev,marca_kit2,tiem_rev,equipo,modelo,iden,elem_ens) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',
                    (llave_form, fecha_form, proc, revis, nivel_il, con_sup, met_insp, tipo_il, check1, check2, check3, detalle, proc_p, revis_p, temp_ens, tipo_il_p, nivel_il_p, mater_base, tipo_sec, tipo_pen, marca_kit, tiem_pen, met_rem, marca_kit1, tiem_sec, for_rev, marca_kit2, tiem_rev, equipo, modelo, iden,elem_ens))
        mysql.connection.commit()
        return redirect(url_for('formu_2_2'))
        #return render_template('formu_1_1.html', form=form)
    return render_template('formu_2.html', form=form)
		


@app.route('/add_formu_2_2', methods=['POST'])
@login_required
def add_formu_2_2():
    form = formu2_2()
    if form.validate_on_submit():
        ...
        pt = request.form['pt']
        cur = mysql.connection.cursor()
        cur.execute("select id from form3 where id = (select MAX(id) from form3) ;")
        llave_form = cur.fetchone()
        print(llave_form)
        cur.execute('insert into form33 (num,ref,cod_enii,tipo_ter,medidas,capac,dia_elin,med_aces,vt,pt,id_f3) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',(num, ref, cod_enii, tipo_ter, medidas, capac, dia_elin, med_aces, vt, pt,llave_form))
        mysql.connection.commit()
        return redirect(url_for('formu_2_2'))
   


@app.route('/formu_2_2', methods=['GET', 'POST'])
@login_required
def formu_2_2():
    form = formu2_2()
    cur = mysql.connection.cursor()
    cur.execute("select * from form33 where id_f3=(select MAX(id) from form3) ;")
    data = cur.fetchall()
    return render_template('formu_2_2.html',form = form, data = data)
...
def get_contact1(id):
    cur = mysql.connection.cursor()
    cur.execute('SELECT * FROM form3 WHERE id = %s', (id))
    data = cur.fetchall()
    cur.close()
    print(data[0])
    return render_template('edit-form3.html', contact = data[0])
...
def update_form3(id):
    if request.method == 'POST':
        ...
        flash('Contact Updated Successfully')
        mysql.connection.commit()
        return redirect(url_for('resumen2'))
...
def resumen2():
    ...
    cursor.execute(
        "select * from form3 where id_formulario = (select MAX(id_formulario) from formulario);")
    datos1 = cursor.fetchall()
    cursor.execute(
        "select MAX(id) from form3 ;")
    data1 = cursor.fetchone()
    cursor.execute(
        "select * from form33 where id_f3 = (select MAX(id) from form3) ;")
    data = cursor.fetchall()
    print(data1)
    print(data)
    return render_template('resumen2.html', datos=nom_form, fec1=fec_insp, fec2=fec_emi, fec3=fec_exp, lugar=lugar, inspector=inpe, datos1=datos1,contact = data1[0],data=data)


@app.route('/formu_3', methods=['GET', 'POST'])
@login_required
def formu_3():
    form = formu3()
    if form.validate_on_submit():
        ...
        cur.execute(
            "select fecha_inspec_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario) ;")
        fecha_form = cur.fetchone()
        cur.execute('insert into form4 (id_formulario,fec_formulario,proc,revis,nivel_il,con_sup,met_insp,tipo_il,check1,check2,check3,detalle,proc_p,revis_p,temp_ens,tipo_il_p,nivel_il_p,mater_base,tipo_sec,num,ref,cod_enii,vt,pt,tipo_pen,marca_kit,tiem_pen,met_rem,marca_kit1,tiem_sec,for_rev,marca_kit2,tiem_rev,equipo,modelo,iden,eslabon,medidas,capac,gancho1,gancho2,tipo_ace) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',
                    (llave_form, fecha_form, proc, revis, nivel_il, con_sup, met_insp, tipo_il, check1, check2, check3, detalle, proc_p, revis_p, temp_ens, tipo_il_p, nivel_il_p, mater_base, tipo_sec, num, ref, cod_enii, vt, pt, tipo_pen, marca_kit, tiem_pen, met_rem, marca_kit1, tiem_sec, for_rev, marca_kit2, tiem_rev, equipo, modelo, iden, eslabon, medidas, capac, gancho1, gancho2, tipo_ace))
        mysql.connection.commit()
        return redirect(url_for('reporte_foto1'))
    return render_template('formu_3.html', form=form)


@app.route('/formu_4', methods=['GET', 'POST'])
@login_required
def formu_4():
    form = formu4()
    if form.validate_on_submit():
        ...
        cur.execute(
            "select fecha_inspec_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario) ;")
        fecha_form = cur.fetchone()
        cur.execute('insert into form5 (id_formulario,fec_formulario,proc,revis,nivel_il,con_sup,met_insp,tipo_il,check1,check2,check3,detalle,num,ref,cod_enii,vt,equipo,modelo,iden,medidas,capac,tipo) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',
                    (llave_form, fecha_form, proc, revis, nivel_il, con_sup, met_insp, tipo_il, check1, check2, check3, detalle, num, ref, cod_enii, vt, equipo, modelo, iden, medidas, capac, tipo))
        mysql.connection.commit()
        return redirect(url_for('reporte_foto1'))
    return render_template('formu_4.html', form=form)


@app.route('/formu_5', methods=['GET', 'POST'])
@login_required
def formu_5():
    form = formu5()
    if form.validate_on_submit():
        ...
        cur.execute(
            "select fecha_inspec_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario) ;")
        fecha_form = cur.fetchone()
        cur.execute('insert into form6 (id_formulario,fec_formulario,proc,revis,nivel_il,con_sup,met_insp,tipo_il,check1,check2,check3,detalle,elem_en,proc_p,revis_p,temp_ens,tipo_il_p,nivel_il_p,mater_base,tipo_sec,num,ref,cod_enii,vt,pt,tipo_pen,marca_kit,tiem_pen,met_rem,marca_kit1,tiem_sec,for_rev,marca_kit2,tiem_rev,equipo,modelo,iden,asiento,medidas,capac,garganta) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',
                    (llave_form, fecha_form, proc, revis, nivel_il, con_sup, met_insp, tipo_il, check1, check2, check3, detalle, elem_en, proc_p, revis_p, temp_ens, tipo_il_p, nivel_il_p, mater_base, tipo_sec, num, ref, cod_enii, vt, pt, tipo_pen, marca_kit, tiem_pen, met_rem, marca_kit1, tiem_sec, for_rev, marca_kit2, tiem_rev, equipo, modelo, iden, asiento, medidas, capac, garganta))
        mysql.connection.commit()
        return redirect(url_for('reporte_foto1'))
    return render_template('formu_5.html', form=form)


@app.route('/formu_6', methods=['GET', 'POST'])
@login_required
def formu_6():
    form = formu6()
    if form.validate_on_submit():
        ...
        cur.execute(
            "select fecha_inspec_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario) ;")
        fecha_form = cur.fetchone()
        cur.execute('insert into form7 (id_formulario,fec_formulario,proc,revis,nivel_il,con_sup,met_insp,tipo_il,check1,check2,check3,detalle,elem_en,proc_p,revis_p,temp_ens,tipo_il_p,nivel_il_p,mater_base,tipo_sec,num,ref,cod_enii,vt,pt,tipo_pen,marca_kit,tiem_pen,met_rem,marca_kit1,tiem_sec,for_rev,marca_kit2,tiem_rev,equipo,modelo,iden,diam_cue,medidas,capac) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',
                    (llave_form, fecha_form, proc, revis, nivel_il, con_sup, met_insp, tipo_il, check1, check2, check3, detalle, elem_en, proc_p, revis_p, temp_ens, tipo_il_p, nivel_il_p, mater_base, tipo_sec, num, ref, cod_enii, vt, pt, tipo_pen, marca_kit, tiem_pen, met_rem, marca_kit1, tiem_sec, for_rev, marca_kit2, tiem_rev, equipo, modelo, iden, diam_cue, medidas, capac))
        mysql.connection.commit()
        return redirect(url_for('reporte_foto1'))
    return render_template('formu_6.html', form=form)


@app.route('/formu_7', methods=['GET', 'POST'])
@login_required
def formu_7():
    form = formu7()
    if form.validate_on_submit():
...
def formu_9():
    ...
    if form.validate_on_submit():
        ...
        cur.execute('insert into form10 (id_formulario,fec_formulario,proc,revis,nivel_il,con_sup,met_insp,tipo_il,check1,check2,check3,detalle,proc_p,revis_p,temp_ens,tipo_il_p,nivel_il_p,mater_base,tipo_sec,marca_pk,iden_pk,modelo_pk,vt,pt,tipo_pen,marca_kit,tiem_pen,met_rem,marca_kit1,tiem_sec,for_rev,marca_kit2,tiem_rev,capac_pk,obs) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',
                    (llave_form, fecha_form, proc, revis, nivel_il, con_sup, met_insp, tipo_il, check1, check2, check3, detalle, proc_p, revis_p, temp_ens, tipo_il_p, nivel_il_p, mater_base, tipo_sec, marca_pk, iden_pk, modelo_pk, vt, pt, tipo_pen, marca_kit, tiem_pen, met_rem, marca_kit1, tiem_sec, for_rev, marca_kit2, tiem_rev, capac_pk, obs))
        mysql.connection.commit()
        return redirect(url_for('reporte_foto1'))
...
def formu_11():
    ...
    if form.validate_on_submit():
        ...
        cur.execute(
            "select fecha_inspec_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario) ;")
        fecha_form = cur.fetchone()
        cur.execute('insert into form12 (id_formulario,fec_formulario,proc,revis,nivel_il,con_sup,met_insp,tipo_il,check1,check2,check3,detalle,proc_p,revis_p,temp_ens,tipo_il_p,nivel_il_p,mater_base,tipo_sec,tipo_pen,marca_kit,tiem_pen,met_rem,marca_kit1,tiem_sec,for_rev,marca_kit2,tiem_rev,equipo,modelo,iden,marca_pas,iden_pas,modelo_pas,cap_pas,numero,marca,iden1,obs,vt,pt) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',
...
def resumen1():
    ...
    inpe = cursor.fetchone()
    cursor.execute(
        "select * from form2 where id_formulario = (select MAX(id_formulario) from formulario);")
    datos1 = cursor.fetchall()
    cursor.execute(
        "select MAX(id) from form2 ;")
    data1 = cursor.fetchone()
    cursor.execute(
        "select * from form22 where id_f2 = (select MAX(id) from form2) ;")
    data = cursor.fetchall()
    print(data1)
    print(data)
    return render_template('resumen1.html', datos=nom_form, fec1=fec_insp, fec2=fec_emi, fec3=fec_exp, lugar=lugar, inspector=inpe, datos1=datos1,contact = data1[0],data=data)
...
def cert_for1():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select num from form2 where id_formulario = (select MAX(id_formulario) from formulario);")
    numero = cursor.fetchone()
    cursor.execute(
        "select cod_enii from form2 where id_formulario = (select MAX(id_formulario) from formulario);")
    cod_enii = cursor.fetchone()
    cursor.execute(
        "select ref from form2 where id_formulario = (select MAX(id_formulario) from formulario);")
    ref = cursor.fetchone()
    cursor.execute(
        "select ancho from form2 where id_formulario = (select MAX(id_formulario) from formulario);")
    ancho = cursor.fetchone()
    cursor.execute(
        "select diam from form2 where id_formulario = (select MAX(id_formulario) from formulario);")
...
def cert_for2():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select num from form3 where id_formulario = (select MAX(id_formulario) from formulario);")
    numero = cursor.fetchone()
    cursor.execute(
        "select cod_enii from form3 where id_formulario = (select MAX(id_formulario) from formulario);")
    cod_enii = cursor.fetchone()
    cursor.execute(
        "select ref from form3 where id_formulario = (select MAX(id_formulario) from formulario);")
    ref = cursor.fetchone()
    cursor.execute(
        "select tipo_ter from form3 where id_formulario = (select MAX(id_formulario) from formulario);")
    tipo_ter = cursor.fetchone()
    cursor.execute(
        "select medidas from form3 where id_formulario = (select MAX(id_formulario) from formulario);")
    medidas = cursor.fetchone()
    cursor.execute(
        "select capac from form3 where id_formulario = (select MAX(id_formulario) from formulario);")
...
def cert_for3():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select num from form4 where id_formulario = (select MAX(id_formulario) from formulario);")
    numero = cursor.fetchone()
    cursor.execute(
        "select cod_enii from form4 where id_formulario = (select MAX(id_formulario) from formulario);")
    cod_enii = cursor.fetchone()
    cursor.execute(
        "select ref from form4 where id_formulario = (select MAX(id_formulario) from formulario);")
    ref = cursor.fetchone()
    cursor.execute(
        "select tipo_ace from form4 where id_formulario = (select MAX(id_formulario) from formulario);")
    tipo_ter = cursor.fetchone()
    cursor.execute(
        "select medidas from form4 where id_formulario = (select MAX(id_formulario) from formulario);")
    medidas = cursor.fetchone()
    cursor.execute(
        "select capac from form4 where id_formulario = (select MAX(id_formulario) from formulario);")
    capac = cursor.fetchone()
    cursor.execute(
        "select fecha_emision_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario);")
    fec_emi = cursor.fetchone()
...
def cert_for4():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select num from form5 where id_formulario = (select MAX(id_formulario) from formulario);")
    numero = cursor.fetchone()
    cursor.execute(
        "select cod_enii from form5 where id_formulario = (select MAX(id_formulario) from formulario);")
    cod_enii = cursor.fetchone()
    cursor.execute(
        "select ref from form5 where id_formulario = (select MAX(id_formulario) from formulario);")
    ref = cursor.fetchone()
    cursor.execute(
        "select tipo from form5 where id_formulario = (select MAX(id_formulario) from formulario);")
    tipo_ter = cursor.fetchone()
    cursor.execute(
        "select medidas from form5 where id_formulario = (select MAX(id_formulario) from formulario);")
    medidas = cursor.fetchone()
    cursor.execute(
        "select capac from form5 where id_formulario = (select MAX(id_formulario) from formulario);")
    capac = cursor.fetchone()
    cursor.execute(
        "select fecha_emision_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario);")
    fec_emi = cursor.fetchone()
...
def cert_for5():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select num from form6 where id_formulario = (select MAX(id_formulario) from formulario);")
    numero = cursor.fetchone()
    cursor.execute(
        "select cod_enii from form6 where id_formulario = (select MAX(id_formulario) from formulario);")
    cod_enii = cursor.fetchone()
    cursor.execute(
        "select ref from form6 where id_formulario = (select MAX(id_formulario) from formulario);")
    ref = cursor.fetchone()
    cursor.execute(
        "select tipo_il from form6 where id_formulario = (select MAX(id_formulario) from formulario);")
    tipo_ter = cursor.fetchone()
    cursor.execute(
        "select medidas from form6 where id_formulario = (select MAX(id_formulario) from formulario);")
    medidas = cursor.fetchone()
    cursor.execute(
        "select capac from form6 where id_formulario = (select MAX(id_formulario) from formulario);")
    capac = cursor.fetchone()
    cursor.execute(
        "select fecha_emision_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario);")
    fec_emi = cursor.fetchone()
...
def cert_for6():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select num from form7 where id_formulario = (select MAX(id_formulario) from formulario);")
    numero = cursor.fetchone()
    cursor.execute(
        "select cod_enii from form7 where id_formulario = (select MAX(id_formulario) from formulario);")
    cod_enii = cursor.fetchone()
    cursor.execute(
        "select ref from form7 where id_formulario = (select MAX(id_formulario) from formulario);")
    ref = cursor.fetchone()
    cursor.execute(
        "select tipo_il from form7 where id_formulario = (select MAX(id_formulario) from formulario);")
    tipo_ter = cursor.fetchone()
    cursor.execute(
        "select medidas from form7 where id_formulario = (select MAX(id_formulario) from formulario);")
    medidas = cursor.fetchone()
    cursor.execute(
        "select capac from form7 where id_formulario = (select MAX(id_formulario) from formulario);")
    capac = cursor.fetchone()
    cursor.execute(
        "select fecha_emision_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario);")
    fec_emi = cursor.fetchone()
...
def cert_for7():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select marca_pk from form8 where id_formulario = (select MAX(id_formulario) from formulario);")
    marca_pk = cursor.fetchone()
    cursor.execute(
        "select modelo_pk from form8 where id_formulario = (select MAX(id_formulario) from formulario);")
    modelo_pk = cursor.fetchone()
    cursor.execute(
        "select iden_pk from form8 where id_formulario = (select MAX(id_formulario) from formulario);")
    iden_pk = cursor.fetchone()
    cursor.execute(
        "select capac_pk from form8 where id_formulario = (select MAX(id_formulario) from formulario);")
...
def cert_for8():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select equipo from form9 where id_formulario = (select MAX(id_formulario) from formulario);")
    equipo = cursor.fetchone()
    cursor.execute(
        "select marca_pk from form9 where id_formulario = (select MAX(id_formulario) from formulario);")
    marca_pk = cursor.fetchone()
    cursor.execute(
        "select modelo_pk from form9 where id_formulario = (select MAX(id_formulario) from formulario);")
    modelo_pk = cursor.fetchone()
    cursor.execute(
        "select iden_pk from form9 where id_formulario = (select MAX(id_formulario) from formulario);")
    iden_pk = cursor.fetchone()
    cursor.execute(
        "select capac_pk from form9 where id_formulario = (select MAX(id_formulario) from formulario);")
    capac_pk = cursor.fetchone()
    cursor.execute(
        "select fecha_emision_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario);")
    fec_emi = cursor.fetchone()
...
def cert_for9():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select marca_pk from form10 where id_formulario = (select MAX(id_formulario) from formulario);")
    marca_pk = cursor.fetchone()
    cursor.execute(
        "select modelo_pk from form10 where id_formulario = (select MAX(id_formulario) from formulario);")
    modelo_pk = cursor.fetchone()
    cursor.execute(
        "select iden_pk from form10 where id_formulario = (select MAX(id_formulario) from formulario);")
    iden_pk = cursor.fetchone()
    cursor.execute(
        "select capac_pk from form10 where id_formulario = (select MAX(id_formulario) from formulario);")
    capac_pk = cursor.fetchone()
    cursor.execute(
        "select fecha_emision_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario);")
    fec_emi = cursor.fetchone()
...
def cert_for10():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select marca_hd from form11 where id_formulario = (select MAX(id_formulario) from formulario);")
    marca_hd = cursor.fetchone()
    cursor.execute(
        "select iden_hd from form11 where id_formulario = (select MAX(id_formulario) from formulario);")
    iden_hd = cursor.fetchone()
    cursor.execute(
        "select medidas_hd from form11 where id_formulario = (select MAX(id_formulario) from formulario);")
    medidas_hd = cursor.fetchone()
    cursor.execute(
        "select capac_hd from form11 where id_formulario = (select MAX(id_formulario) from formulario);")
    capac_hd = cursor.fetchone()
    cursor.execute(
        "select marca_hi from form11 where id_formulario = (select MAX(id_formulario) from formulario);")
    marca_hi = cursor.fetchone()
    cursor.execute(
        "select iden_hi from form11 where id_formulario = (select MAX(id_formulario) from formulario);")
    iden_hi = cursor.fetchone()
    cursor.execute(
        "select medidas_hi from form11 where id_formulario = (select MAX(id_formulario) from formulario);")
    medidas_hi = cursor.fetchone()
    cursor.execute(
        "select capac_hi from form11 where id_formulario = (select MAX(id_formulario) from formulario);")
...
def cert_for11():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select marca_pas from form12 where id_formulario = (select MAX(id_formulario) from formulario);")
    marca_pas = cursor.fetchone()
    cursor.execute(
        "select modelo_pas from form12  where id_formulario = (select MAX(id_formulario) from formulario);")
    modelo_pas = cursor.fetchone()
    cursor.execute(
        "select iden_pas from form12 where id_formulario = (select MAX(id_formulario) from formulario);")
    iden_pas = cursor.fetchone()
    cursor.execute(
        "select cap_pas from form12 where id_formulario = (select MAX(id_formulario) from formulario);")
...
def cert_for12():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select marca_pas from form13 where id_formulario = (select MAX(id_formulario) from formulario);")
    marca_pas = cursor.fetchone()
    cursor.execute(
        "select modelo_pas from form13  where id_formulario = (select MAX(id_formulario) from formulario);")
    modelo_pas = cursor.fetchone()
    cursor.execute(
        "select iden_pas from form13 where id_formulario = (select MAX(id_formulario) from formulario);")
    iden_pas = cursor.fetchone()
    cursor.execute(
        "select cap_pas from form13 where id_formulario = (select MAX(id_formulario) from formulario);")
    cap_pas = cursor.fetchone()
    cursor.execute(
        "select fecha_emision_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario);")
    fec_emi = cursor.fetchone()
...
def cert_for13():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select numero from form14 where id_formulario = (select MAX(id_formulario) from formulario);")
    numero = cursor.fetchone()
    cursor.execute(
        "select tipo_acc from form14 where id_formulario = (select MAX(id_formulario) from formulario);")
    tipo_acc = cursor.fetchone()
    cursor.execute(
        "select codigo from form14 where id_formulario = (select MAX(id_formulario) from formulario);")
    codigo = cursor.fetchone()
    cursor.execute(
        "select ref from form14 where id_formulario = (select MAX(id_formulario) from formulario);")
    ref = cursor.fetchone()
    cursor.execute(
        "select medidas from form14 where id_formulario = (select MAX(id_formulario) from formulario);")
    medidas = cursor.fetchone()
    cursor.execute(
        "select cap from form14 where id_formulario = (select MAX(id_formulario) from formulario);")
    cap = cursor.fetchone()
    cursor.execute(
        "select fecha_emision_formulario from formulario where id_formulario = (select MAX(id_formulario) from formulario);")
    fec_emi = cursor.fetchone()
...
def cert_for14():
    cursor = mysql.connection.cursor()
    cursor.execute(
        "select numero from form15 where id_formulario = (select MAX(id_formulario) from formulario);")
    numero = cursor.fetchone()
    cursor.execute(
        "select equipo from form15 where id_formulario = (select MAX(id_formulario) from formulario);")
    equipo = cursor.fetchone()
    cursor.execute(
        "select codigo from form15 where id_formulario = (select MAX(id_formulario) from formulario);")
    codigo = cursor.fetchone()
    cursor.execute(
        "select ref from form15 where id_formulario = (select MAX(id_formulario) from formulario);")
    ref = cursor.fetchone()
    cursor.execute(
        "select medidas from form15 where id_formulario = (select MAX(id_formulario) from formulario);")
    medidas = cursor.fetchone()
    cursor.execute(
        "select cap from form14 where id_formulario = (select MAX(id_formulario) from formulario);")
    cap = cursor.fetchone()
